...
A t-test is used to determine if there is a significant difference between the means of two groups. A t-test compares both the sample mean and the standard deviations while considering the sample size and the degree of variability of the data.
...
-   **Paired samples t-test:** To compare the mean of two dependent samples, e.g., a before-and-after comparison of the same samples.
