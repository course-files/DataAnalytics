...
shapiro.test(sales_performance_data$WeeklySales[sales_performance_data$MarketingStrategy == "Digital"])
shapiro.test(sales_performance_data$WeeklySales[sales_performance_data$MarketingStrategy == "Traditional"])
