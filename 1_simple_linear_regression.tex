...
The test of normality assesses whether the residuals are approximately
normally distributed, i.e., most residuals (errors) are close to zero
and large errors are rare. A Q-Q plot can be used to conduct the test of
normality.
...
Interpretation: If the p-value is less than 0.05, there is statistically
